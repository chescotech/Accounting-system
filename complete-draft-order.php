        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="post" name="autoSumForm" action="add-complete-draft.php">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group" id="tendered">
                                ...
                                <input type="text" style="text-align:right" class="form-control" onFocus="startCalc();" onBlur="stopCalc();" id="cash_paid" value="<?php echo $amount_due; ?>" name="tendered" placeholder="Cash Tendered" autocomplete="off" readonly="">
                            </div><!-- /.form group -->
                    ...
                    <button class="btn btn-md btn-block btn-primary" id="daterange-btn" name="cash" type="submit" tabindex="7">
                        Complete Sales
                    </button>
                    <button class="btn btn-md btn-block" id="daterange-btn" type="reset" tabindex="8">
