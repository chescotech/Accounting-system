        ...
        <div class="modal-content">
            ...
            <form class="payment" id="paymentForm" action="singleinvoice.php" method="post" style="width: 50rem;">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="customerNameInput">Supplier Name</label>
...
<div id="updatebank<?php echo $row['id']; ?>" class="modal fade" tabindex="-1" style="padding: 0.2rem;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
