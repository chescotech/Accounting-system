...
<head>
    ...
    <title>Users | <?php include('../dist/includes/title.php'); ?></title>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        ?></td>
                                                    <td>
                                                        <img style="width:80px;height:60px" src="../dist/uploads/user.jpg">
                                                        <?php
                                                        // $group = $GroupObject->getUserGroup($row['user_id']);
                                                        // var_dump($group);
                                                        // echo $group['name'];
                                                        ?>
                                                    </td>
            ...
            <div class="modal-content" style="height:auto">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="add-user.php" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label for="user_group" class="control-label col-lg-3">User Group</label>
                            <div class="col-lg-9">
                                <select class="form-control select2" style="width: 100%;" name="user_group" id="user_group" required>
                                    <?php
                                    ...
                                    while ($row = mysqli_fetch_array($Groups)) {
                                        ...
                                        $grp_name = $row['name'];
                                    ?>
                                        <option value="<?= $id ?>"><?= $grp_name ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
