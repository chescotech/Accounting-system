                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        echo number_format($row['price'], 2) . ' ( ' . $DAO->getCustomerType($con, $selected_cust_id) . ' ) '; ?>
                                                    </td>
                        ...
                        <form method="post" name="autoSumForm" action="sales_add.php">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a style=" color: blue" href="cust_new.php?type=cash" target="blank_"><b>Add New
                                            Customer</b></a><br></br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="payment_mode_id" tabindex="1">
                                            ...
                                            while ($row = mysqli_fetch_array($query2)) {
                                            ?>
                                                <option value="<?php echo $row['payment_mode_id']; ?>">
