                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="incomplete-draft-reciept.php?orderno=<?php echo $row['order_no']; ?>" style="color: #fff " class="btn btn-success"><b>
                                                                <i class="icon-print"></i> Print</b></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="print-delivery-note.php?orderno=<?php echo $row['order_no']; ?>" style="color: #fff " class="btn btn-success"><b><i class="icon-print"></i> Print</b></i></a>
                                                    </td>
                                                    <td>
                                                        <a href="update-order-draft.php?orderno=<?php echo $row['order_no']; ?>&customer_name=<?php echo $customer_name; ?>" style="color: #fff " class="btn btn-success"><b>View / Update Order</b></i></a>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-success" href="payment-history.php?orderno=<?php echo $row['order_no']; ?>" style="color: #fff "><b><i class="icon-eye-open"></i> View</b></i></a>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-success" href="partial_payment_add.php?orderno=<?php echo $row['order_no']; ?>" style="color: #fff "><b>
                                                                <?php
                                                    ...
                                                    <td>
                                                        <a href="complete-draft-order.php?orderno=<?php echo $row['order_no']; ?>" style="color:white " class="btn btn-danger"><b> <i class="icon-remove"></i> Close</b></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
