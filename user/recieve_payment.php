        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <section class="content-header">
                    <h1>
                        <a class="btn btn-lg btn-warning" href="javascript:(void);" onclick="window.history.back()">Back</a>
                    </h1>
                    <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group" id="tendered">
                                                    ...
                                                    <select class="form-control select2" name="selected_cust_id"
                                                        tabindex="1">
                                                        <option value="none">-- Select Customer --</option>
                                                        <?php

                                                        include('../dist/includes/dbcon.php');
                                                        $query2 = mysqli_query($con, "select * from customer ORDER BY cust_first DESC ") or die(mysqli_error($con));
                                                        while ($row = mysqli_fetch_array($query2)) {
                                                        ?>
                                                        <option value="<?php echo $row['cust_id']; ?>">
                                                            <?php echo " ( " . $row['cust_first'] . ' - ' . $row['cust_last'] . " ) "; ?>
                                                        </option>
                                                        <?php } ?>
                                                    </select>
                                                </div><!-- /.form group -->
                                                <a style=" color: WHITE" href="cust_new.php?type=cash"
                                                    class="btn btn-success"><b>Add New Customer</b></a><br></br>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <button class="btn btn-lg btn-primary" type="submit"
                                                            tabindex="3" name="addtocart">Next</button>
                                                    </div>
                                                </div>
                                    </form>
                                            ...
                                            <div class="modal-content" style="height:auto">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" method="post"
                                                        action="add-item-to-bill.php" enctype='multipart/form-data'>
                                                        <div class="col-md-12">
                                                        </div>
            ...
            <div id="discount_all" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="height:auto">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" action="add-discount-all.php"
