                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <a href="#add_service" data-target="#add_service" data-toggle="modal" style="color:#3c8dbc;" class="small-box-footer"> <b>
                                            <h4>Add Item</h4>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="height:auto">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" method="post" action="add-to-bill-credit.php" enctype='multipart/form-data'>
                                                        <div class="col-md-12">
                                                        </div>
                                                ...
                                                <div id="discount<?php echo $row['temp_trans_id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="height:auto">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post" action="add-discount_draft.php" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" style="text-align:right" class="form-control" id="amount_due" name="date2collect">
