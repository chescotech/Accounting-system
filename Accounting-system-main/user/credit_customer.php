        ...
        <div class="content-wrapper">
            <div class="container">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div id="existing-tab" class="form tab col-md-8">
                            <div class="box box-primary">
                                <div class="box-header">
                                    ...
                                    $query2 = mysqli_query($con, "SELECT SUM(qty) AS qty, prod_sell_price  "
                                        ...
                                        . " AND sales.date_added >= '$loginTime' AND sales.date_added <= '$today' AND user.user_id='$userId' GROUP BY product.prod_name,stock_branch_id") or die(mysqli_error($con));
                                ...
                                <div class="box-body">
                                    ...
                                    ?>
                                    <form method="get" action="credit_note" id="existingForm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group" id="tendered">
                                                    <label for="date">Select Customer</label><br>
                                                    <select class="form-control select2" name="order_no" tabindex="1">
                                                ...
                                                <a style="color: WHITE" href="cust_new.php?type=cash" class="btn btn-success"><b>Add New Customer</b></a><br></br>
                                            </div>
